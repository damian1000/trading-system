package com.damianhoward.positionledger

import com.damianhoward.positionledger.capture.SessionOpens
import com.damianhoward.positionledger.capture.TradeCapture
import com.damianhoward.positionledger.config.AppConfig
import com.damianhoward.positionledger.consume.ConsumerProgress
import com.damianhoward.positionledger.consume.DeadLetterPublisher
import com.damianhoward.positionledger.consume.DltReplay
import com.damianhoward.positionledger.consume.FillConsumer
import com.damianhoward.positionledger.consume.RetryingHandler
import com.damianhoward.positionledger.exposure.BreachDetector
import com.damianhoward.positionledger.exposure.RiskLimits
import com.damianhoward.positionledger.health.Readiness
import com.damianhoward.positionledger.position.JdbcPositionStore
...
import com.damianhoward.positionledger.web.LedgerServer
import com.damianhoward.positionledger.web.SseBroadcaster
...
fun main(args: Array<String>) {
    ...
    val consumer =
        FillConsumer.create(
            ...
            clientId = "position-ledger-fills",
            onFatal = fatal,
        )
    val exposureConsumer =
        FillConsumer.create(
            ...
            handler = detector,
            startOffsets = ledger.highWaterOffsets,
            clientId = "position-ledger-exposure",
            onFatal = fatal,
        )
